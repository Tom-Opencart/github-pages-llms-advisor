...
function buildJsonSettingsPayload(data) {
  return {
    ...
    module_llms_generator_home_page_title: data.siteTitle,
    ...
    module_llms_generator_categories_extended: '0',
    ...
    module_llms_generator_categories_all_output: 'single_file',
    module_llms_generator_categories_specific_output: 'inline',
    ...
    module_llms_generator_products_limit: '10',
    module_llms_generator_products_all_output: 'single_file',
    module_llms_generator_products_specific_output: 'inline',
    ...
    module_llms_generator_pages_all_output: 'single_file',
    module_llms_generator_pages_specific_output: 'inline',
    ...
    module_llms_generator_brands_all_output: 'single_file',
    module_llms_generator_brands_specific_output: 'inline',
